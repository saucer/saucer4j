...
import app.saucer.nativebindings._navigation.saucer_navigation;
import app.saucer.nativebindings._preferences.saucer_preferences;
import app.saucer.nativebindings._scheme.saucer_scheme_handler;
import app.saucer.nativebindings._script.saucer_script;
import app.saucer.nativebindings._icon.saucer_icon;
import app.saucer.nativebindings._window.SAUCER_POLICY;
import app.saucer.nativebindings._window.saucer_handle;
import app.saucer.nativebindings.documentation.BeforeInit;
...
//    void saucer_webview_embed_file(saucer_handle _instance, String name, saucer_embedded_file file, SAUCER_LAUNCH policy);
    ...
    /**
     * @param policy {@link SAUCER_POLICY}
     */
